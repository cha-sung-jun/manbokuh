(function($){$.galleryUtility={};$.galleryUtility.centerImage={};$.galleryUtility.rightImage={};$.galleryUtility.leftImage={};$.galleryUtility.rightImageStorage={};$.galleryUtility.leftImageStorage={};$.galleryUtility.zoomImage={};$.galleryUtility.gallery={};$.galleryUtility.Options={container:null,Lheight:493,Lwidth:370,Lshrink:function(dimension){return dimension*0.75;},Lzoom:function(dimension){return dimension*1.4;},Pheight:400,Pwidth:300,Pshrink:function(dimension){return dimension*0.75;},Pzoom:function(dimension){return dimension*2;},defaultLayout:'landscape',startClass:'start',slideSpeed:'normal',zoomSpeed:'fast',gutterWidth:50,captionUpPath:'../images/captionUpArrow.png',captionUpWidth:0,captionUpHeight:0,captionUpID:'captionArrowUp',captionDownPath:'images/captionDownArrow.png',captionDownWidth:0,captionDownHeight:0,captionDownID:'captionArrowDown',captionHeight:function(zoomHeight){return zoomHeight*0;},captionStyle:'background-color:white; color:white; opacity: 0; filter: alpha(opacity = 0); font-size: 0px; text-align:center;',captionClass:'captionBox',captionID:'activeCaption',captionTextAttribute:'caption',useCaptions:false};$.fn.slidingGallery=function(options){$.extend($.galleryUtility.Options,options);$('body').css('overflow-x','hidden');var container=null;if(!$.galleryUtility.Options.container){$.galleryUtility.Options.container=$('body');}else{$.galleryUtility.Options.container.css('position','relative');}
